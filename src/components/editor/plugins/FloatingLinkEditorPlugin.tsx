...
function FloatingLinkEditor({
    ...
    return (
        <div
            ref={editorRef}
            className="link-editor absolute top-0 left-0 z-50 max-w-[400px] w-full opacity-0 bg-[var(--background)] border border-[var(--border-color)] rounded-lg shadow-lg transition-opacity"
        >
